...
export default function CommissionReportPage() {
    return (
        <div className="p-8 space-y-6">
            <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Commission Report</h1>
                <p className="text-gray-500 dark:text-gray-400 mt-1">Commission analytics</p>
            </div>
