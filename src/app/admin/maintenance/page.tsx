...
export default function MaintenanceModePage() {
    return (
        <div className="p-8 space-y-6">
            <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Maintenance Mode</h1>
                <p className="text-gray-500 dark:text-gray-400 mt-1">System maintenance controls</p>
            </div>
