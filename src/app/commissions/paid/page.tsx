    ...
    return (
        <div className="p-8 space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Paid Commissions</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Commission payment history</p>
                </div>
