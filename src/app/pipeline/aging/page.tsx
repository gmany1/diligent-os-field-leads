...
export default function AgingAnalysisPage() {
    return (
        <div className="p-8 space-y-6">
            <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Aging Analysis</h1>
                <p className="text-gray-500 dark:text-gray-400 mt-1">Leads by time in current stage</p>
            </div>
